								  ...
								  <div class="row mb-4">
								    <div class="col">
								      <div class="form-outline">
								        <input type="text" id="accin" name="p_name" class="form-control" value="<?php echo $owner_name?>"  />
								        <label class="form-label" for="form6Example1">Owner Name</label>
								      </div>
								    </div>
								    <div class="col">
								      <div class="form-outline">
								        <input type="text" id="accin" name="l_name" class="form-control" value="<?php echo $unique_id?>" />
