<?php 
  ...
  $fetchUserConsult = "SELECT * FROM users WHERE type_of_user = 'Patient'  ";
  $fetchUserConsultQuery = mysqli_query($con, $fetchUserConsult);

  // $getEachUserData_query = "SELECT unique_id FROM consultation WHERE"
        ...
        <div class="row ">
                <div class="col-lg">
                  ...
                  <table id="table1" class="table-dark table-sm table-bordered " style="text-align: center;">
                          <thead >
                            <tr>
                              <th scope="col" class="A-cont">Owner Name</th>
                              <th scope="col" class="A-own">ID Code</th>
                              <th scope="col" class="A-act" id="A-act1">Action</th>                       
                            </tr>
                            </thead>
                     <?php                       
                         while($row=mysqli_fetch_assoc($fetchUserConsultQuery))
                            {
                ...
                <tr class="table table-dark table-striped table-sm table-bordered" style="color: black;">                  
                    ...
                    <td><a class="btn btn-xs btn-info" href="viewrecords.php?GetID=<?php echo $unique_id ?>">View Data</a></td>
                </tr> 
                    <?php 
                         }  
                    ?> 
