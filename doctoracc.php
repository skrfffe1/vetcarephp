<?php 
    ...
    if(isset($_POST['save_profile']))
    {
        ...
        if($result)
        {
            echo "<script>alert('Successfully Save your Profile!'); window.location='DoctorDashboard.php'</script>";
        }
        else
        {
            echo "<script>alert('An error occured please try again !!!'); window.location='DoctorDashboard.php'</script>";
        }
    }
    else
    {
