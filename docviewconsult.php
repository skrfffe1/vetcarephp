								  ...
								  <div class="row mb-4">
								    <div class="col">
								      <div class="form-outline">
								        <input readonly type="text" id="accin" name="owner_name" class="form-control" value="<?php echo $owner_name?>"  />
								        <label class="form-label" for="form6Example1">Owner Name</label>
								      </div>
								    </div>
								    <div class="col">
								      <div class="form-outline">
								        <input readonly type="text" id="accin" name="unique_id" class="form-control" value="<?php echo $unique_id?>" />
								        <label class="form-label" for="form6Example2">Unique ID</label>
								      </div>
								    </div>
								  </div>
